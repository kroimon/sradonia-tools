...
public class DialogTranslation extends Translation<Dialog> {

	public DialogTranslation(Dialog object, String key, Object... params) {
		super(object, key, params);
	}

	@Override
	public void translate(StringBundle bundle) {
		object.setTitle(bundle.getString(key, params));
	}
